...
export default class WordCounter extends Writable {
  protected _n: number;
  protected _wordCounts: { [key: string]: number };
  ...
  _write(data: Buffer, encoding: string, callback: (error?: any) => any) {
